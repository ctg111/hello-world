...
export default class Container extends Component{
    constructor(props) {
        ...
        this.changePopBox = this.changePopBox.bind(this);
    ...
    //             set:2
    //         })
    //     }else if(this.props.location.pathname=='/teacher/t-content'){
    //         this.setState({
    //             set:3
    //         })
    //     }
    ...
    render(){
        ...
        return(
            <div className="data-reactroot" onScroll={this.scroll} ref="box">
  ...
  changePopBox(){
      if(!this.state.flag){
          return false
      }else if(this.props.location.pathname=="/teacher/index"){
         return  <Mask flag={this.state.flag}
                showMask={this.state.showMask}
                cancelMask={this.cancelMask}
                changeScore={this.changeScore}
                rewards={this.state.data.rewards}
          />
      }else{
         return  <Dpop flag={this.state.flag} showMask={this.state.showMask}
                cancelMask={this.cancelMask}
                students={this.state.data.students}
    ...
    // }
    // changeIncrease(){
    //     var val=this.state.defaultValue;
    //     this.setState({
    //         arr:[val,...this.state.defaultValue],
    //         flag: false
    //     })
    // }
    ...
    changeThree(){
        if(this.props.location.pathname=='/teacher/index'){
            hashHistory.push("/teacher/t-content");
        }else if(this.props.location.pathname=='/teacher/t-content'){
